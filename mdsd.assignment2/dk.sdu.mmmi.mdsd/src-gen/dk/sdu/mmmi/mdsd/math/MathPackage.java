...
public interface MathPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the containment reference list '{@link dk.sdu.mmmi.mdsd.math.MathExp#getVars <em>Vars</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Vars</em>'.
   * @see dk.sdu.mmmi.mdsd.math.MathExp#getVars()
   * @see #getMathExp()
   * @generated
   */
  EReference getMathExp_Vars();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference MATH_EXP__VARS = eINSTANCE.getMathExp_Vars();
