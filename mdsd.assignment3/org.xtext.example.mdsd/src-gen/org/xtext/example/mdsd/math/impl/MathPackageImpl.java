...
import org.xtext.example.mdsd.math.Binding;
...
import org.xtext.example.mdsd.math.MathFactory;
...
public class MathPackageImpl extends EPackageImpl implements MathPackage
{
   ...
   * @generated
   */
  private EClass externalDeclEClass = null;
   ...
   * @see org.xtext.example.mdsd.math.MathPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   */
  @Override
  public EClass getExternalDecl()
  {
    return externalDeclEClass;
  }
   ...
   */
  @Override
  public EAttribute getExternalDecl_Name()
  {
    return (EAttribute)externalDeclEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EAttribute getExternalDecl_Parameters()
  {
    return (EAttribute)externalDeclEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    externalDeclEClass = createEClass(EXTERNAL_DECL);
    createEAttribute(externalDeclEClass, EXTERNAL_DECL__NAME);
    createEAttribute(externalDeclEClass, EXTERNAL_DECL__PARAMETERS);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getMathExp_Externals(), this.getExternalDecl(), null, "externals", null, 0, -1, MathExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(externalDeclEClass, ExternalDecl.class, "ExternalDecl", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getExternalDecl_Name(), ecorePackage.getEString(), "name", null, 0, 1, ExternalDecl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getExternalDecl_Parameters(), ecorePackage.getEString(), "parameters", null, 0, -1, ExternalDecl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getFunctionCall_Name(), this.getExternalDecl(), null, "name", null, 0, 1, FunctionCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
