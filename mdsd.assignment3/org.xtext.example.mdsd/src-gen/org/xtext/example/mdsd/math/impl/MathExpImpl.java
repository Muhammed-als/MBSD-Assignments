 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mdsd.math.impl.MathExpImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.mdsd.math.impl.MathExpImpl#getExternals <em>Externals</em>}</li>
 *   <li>{@link org.xtext.example.mdsd.math.impl.MathExpImpl#getVariables <em>Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MathExpImpl extends MinimalEObjectImpl.Container implements MathExp
{
   ...
   * @ordered
   */
  protected EList<ExternalDecl> externals;
   ...
   */
  @Override
  public EList<ExternalDecl> getExternals()
  {
    if (externals == null)
    {
      externals = new EObjectContainmentEList<ExternalDecl>(ExternalDecl.class, this, MathPackage.MATH_EXP__EXTERNALS);
    }
    return externals;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case MathPackage.MATH_EXP__EXTERNALS:
        getExternals().clear();
        getExternals().addAll((Collection<? extends ExternalDecl>)newValue);
        return;
      case MathPackage.MATH_EXP__VARIABLES:
        getVariables().clear();
