...
import org.xtext.example.mdsd.ide.contentassist.antlr.internal.InternalMathParser;
...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExternalDeclAccess().getGroup(), "rule__ExternalDecl__Group__0");
			builder.put(grammarAccess.getExternalDeclAccess().getGroup_3(), "rule__ExternalDecl__Group_3__0");
			builder.put(grammarAccess.getExternalDeclAccess().getGroup_3_1(), "rule__ExternalDecl__Group_3_1__0");
			...
			builder.put(grammarAccess.getExternalDeclAccess().getNameAssignment_1(), "rule__ExternalDecl__NameAssignment_1");
			builder.put(grammarAccess.getExternalDeclAccess().getParametersAssignment_3_0(), "rule__ExternalDecl__ParametersAssignment_3_0");
			builder.put(grammarAccess.getExternalDeclAccess().getParametersAssignment_3_1_1(), "rule__ExternalDecl__ParametersAssignment_3_1_1");
